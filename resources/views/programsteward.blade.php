...
<script>
 var time = new Date();
  ...
  <div class="modal-wrapper hidden">
    ...
    @if(Session::get('user')->tip_angajat !== 'Director steward')
      <div class="row">
  ...
  <div class="hidden modal-row-blueprint">
    <div class="row">
      ...
      <select class="activity" {{Session::get('user')->tip_angajat == 'Director steward' ?"disabled":""}}>
  ...
  <script>
    ...
    */
    ...
    $('.save').on('click',function(ev){
      ...
      stewarzi_.forEach(pilot=>{
         if($(steward).find('.stewards').val() == '-1')
              return;
         else{
           temp = {};
           temp.idAngajat = $(steward).find('.pilots').val();
